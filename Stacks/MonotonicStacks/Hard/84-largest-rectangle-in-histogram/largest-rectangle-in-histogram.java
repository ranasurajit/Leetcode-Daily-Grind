class Solution {
     ...
     * SC: O(1)
     */
    private void previousSmallerElement(int[] heights, int[] pse, int n, Stack<Integer> st) {
        for (int i = 0; i < n; i++) { // TC: O(N)
     ...
     * SC: O(1)
     */
    private void nextSmallerElement(int[] heights, int[] nse, int n, Stack<Integer> st) {
