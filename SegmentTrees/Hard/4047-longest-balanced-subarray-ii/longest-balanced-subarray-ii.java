class Solution {
    ...
    public int longestBalanced(int[] nums) {
        ...
        HashMap<Integer, Integer> prevIndex = new HashMap<>(); // SC: O(N)
        /**
         * Segment tree to maintain balance at each position
         * balance[i] = (count of distinct evens from i to end) - 
         * (count of distinct odds from i to end)
         */
    ...
    /**
     * Approach I : Using Brute-Force (Hashing + Two Pointers) Approach
     *
     * TC: O(N²)
     * SC: O(N)
     *
     * Time Limit Exceeded (981 / 999 testcases passed)
     */
    public int longestBalancedBruteForce(int[] nums) {
        ...
        for (int i = 0; i < n; i++) {     // TC: O(N)
            ...
            int balance = 0; // reset balance to 0
